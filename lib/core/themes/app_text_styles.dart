...
class AppTextStyles {
  ...
  static TextStyle ralewayFont18Medium(BuildContext context) => TextStyle(
        fontSize: getResponsiveFontSize(context, fontSize: PaddingDimensions.large),
  ...
  static TextStyle playfairFont64Bold(BuildContext context) => TextStyle(
        fontSize: getResponsiveFontSize(context, fontSize: PaddingDimensions.xxxxLarge),
        fontWeight: FontWeight.bold,
        fontFamily: AppStrings.playfairFontFamily,
      );

  static TextStyle playfairFont32Bold(BuildContext context) => TextStyle(
        fontSize: getResponsiveFontSize(context, fontSize: PaddingDimensions.xxLarge),
        fontWeight: FontWeight.bold,
        fontFamily: AppStrings.playfairFontFamily,
      );

  static TextStyle playfairFont24Bold(BuildContext context) => TextStyle(
        fontSize: getResponsiveFontSize(context, fontSize: PaddingDimensions.xLarge),
        fontWeight: FontWeight.bold,
        fontFamily: AppStrings.playfairFontFamily,
      );
